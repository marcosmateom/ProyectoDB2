...
public class UpdateCita extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (answ == 1) {
                response.sendRedirect("http://localhost:8080/proyectoDB2-seguro/citas_h.jsp?up=1");
            } else {
                response.sendRedirect("http://localhost:8080/proyectoDB2-seguro/citas_h.jsp?up=0");
            }
